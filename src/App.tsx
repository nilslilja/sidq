...
const Pill = lazy(() =>
  import("@/routes/Pill").then((m) => ({ default: m.Pill })),
);
 ...
 *
 * Split out so the build can render these pages to static HTML with a
 * StaticRouter, which is a different router than the browser gets and cannot
 * be swapped at runtime. Nothing else about the tree changed.
 */
