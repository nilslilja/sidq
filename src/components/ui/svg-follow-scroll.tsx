...
// Upstream imports the React default; unused under the automatic JSX transform,
// and this project compiles with noUnusedLocals.
...
export { Skiper19, LINE_PATH_D, LinePath };

/** The upstream path, exported so the shipped hero reuses it rather than forking. */
const LINE_PATH_D =
