    ...
    <section className="relative overflow-hidden" aria-labelledby="hero">
      ...
      <div className="relative mx-auto max-w-[76rem] px-6 pt-24 lg:pt-32">
        ...
        <ScrollTilt className="mt-16 lg:mt-20">
          <ProductVideo caption="Sidq hangs off the menu bar. One keystroke opens every conversation you have had with any AI, and the one you pick is carried into the next one word for word." />
        </ScrollTilt>
      </div>
    </section>
  );
...
function Sky() {
  return (
    <div
      aria-hidden="true"
      className="pointer-events-none absolute inset-x-0 top-0 h-[62rem]"
    >
